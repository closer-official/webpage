...
const TEMPLATE_CSS_RAW = {
  ...
  .wo-nav-drawer a { display: block; color: #fff; text-decoration: none; font-size: 1.05rem; font-weight: 500; padding: 0.65rem 0; border-bottom: 1px solid rgba(255,255,255,0.08); }
  ...
  .wo-hero-strip { position: absolute; left: 0; top: 0; bottom: 0; width: min(18%, 5.5rem); background: var(--tp-brand); z-index: 2; pointer-events: none; opacity: 0.92; }
  ...
  .page-wrapper.template-warm_organic .section.wo-sec { border: none; border-radius: 0; margin-bottom: 0; background: var(--tp-bg); border-left: 4px solid var(--tp-brand); box-shadow: 0 1px 0 rgba(45,55,48,0.06); }
  .page-wrapper.template-warm_organic .section.wo-lede { background: var(--tp-band); border-left-color: var(--tp-brand); margin-top: 0; }
  .page-wrapper.template-warm_organic .section.wo-lede h2 { font-size: 1.5rem; color: var(--tp-brand); font-weight: 600; margin-bottom: 0.75rem; }
  .page-wrapper.template-warm_organic .section.wo-lede .section-body p { color: var(--tp-text); font-size: 0.95rem; line-height: 1.75; }
  .page-wrapper.template-warm_organic .section.wo-hours-band { background: var(--tp-hours-bg); border-left: none; padding-left: 0; box-shadow: none; }
  .page-wrapper.template-warm_organic .section.wo-hours-band .hours-band-inner { padding: 1rem 1.25rem; background: var(--tp-hours-bg); border-radius: 0.25rem; margin-bottom: 1rem; color: var(--tp-heading); font-size: 0.9rem; font-weight: 500; }
  .page-wrapper.template-warm_organic .section.wo-hours-band h2 { color: var(--tp-brand); font-size: 1.1rem; margin: 0; }
  ...
  .page-wrapper.template-warm_organic .section.wo-sec h2 { color: var(--tp-heading); font-size: 1.15rem; font-weight: 600; margin-bottom: var(--space-sm); }
  .page-wrapper.template-warm_organic .section.wo-sec:not(.wo-lede):not(.wo-hours-band) p { font-size: 0.92rem; line-height: 1.7; }
  ...
  .page-wrapper.template-warm_organic .quote-block { color: var(--tp-heading); border-left: 4px solid var(--tp-brand); background: var(--tp-band); padding: 1.25rem 1.5rem; margin: var(--space-xl) 0; font-style: italic; border-radius: 0 0.25rem 0.25rem 0; }
  .page-wrapper.template-warm_organic .sns-links.wo-sns a { display: inline-flex; align-items: center; justify-content: center; width: 2.75rem; height: 2.75rem; margin: 0.35rem; border-radius: 50%; background: var(--tp-brand); color: #fff; text-decoration: none; font-size: 0.65rem; font-weight: 700; }
  .page-wrapper.template-warm_organic .sns-links.wo-sns a:hover { background: #4a6354; }
