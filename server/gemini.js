 ...
 * 「こんなにいいお店なのにウェブがないなんてもったいない、勝手に作った。この魅力をこう反映した」
 * という趣旨で、店ごとに内容を変えた文章にする。
 */
...
- 趣旨：「こんなにいいお店なのにウェブページがないなんてもったいないと思い、勝手に作ってしまいました。このお店のこういう魅力を、こういう形でページに反映したつもりです」という流れで、店ごとに内容がまったく違う文章にすること。
- その店の「コンセプト」「強み」を具体的に盛り込み、どの魅力をどのようにページに活かしたかが伝わるように書く。
