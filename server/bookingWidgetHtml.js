...
export function renderBookingHeadMeta(itemId, apiOrigin) {
...
/**
 * @param {{ ctaLabel: string, siteName: string }} p
 */
export function renderBookingBodyWidget(p) {
