...
export const GALLERY_STATIC_STRINGS = {
  en: {
    ...
    'gallery.searchPh': 'Search by keyword (name, tags, category…)',
    ...
    'gallery.empty.filter': 'No templates match your search.',
  ...
  ja: {
    ...
    'gallery.searchPh': 'キーワードで検索（名前・タグ・カテゴリ名など）',
    ...
    'gallery.empty.filter': '検索に一致するテンプレートがありません。',
