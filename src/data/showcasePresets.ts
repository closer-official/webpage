...
export const SHOWCASE_BY_STYLE_ID: Record<StyleId, { content: PageContent; seo: SEOData }> = {
  ...
  gym_yoga: {
    content: {
      ...
      gymMenuCards: [
        { title: 'パーソナル（対面）', body: 'ジムまたは出張でマンツーマン指導。カウンセリング→トレーニング→アフターフォローまで一貫してサポート。', price: '要相談' },
      ...
      faqItems: [
        ...
        { q: '予約の流れを教えてください', a: 'まずはLINEまたは予約ボタンからお申し込みください。日程調整ののち、初回カウンセリング→トレーニング→アフターフォローの流れです。当日の現金またはキャッシュレス決済でお支払いいただけます。' },
      ],
      sections: [
        ...
        { id: 'staff', title: 'トレーナー', content: 'NSCA-CPT保持。初心者に寄り添う丁寧な指導と、結果にこだわるプログラムで伴走します。' },
        { id: 'menu', title: 'コース・料金', content: 'パーソナル（対面）とオンラインコーチングをご用意。ご希望に合わせたプランをご提案します。' },
        { id: 'access', title: 'アクセス', content: '〒XXX-XXXX 〇〇県〇〇市〇〇 1-2-3\n〇〇駅より徒歩3分' },
        { id: 'contact', title: '予約・申し込み', content: 'ご予約は下のボタンから。当日の現金またはキャッシュレス決済でお支払いいただけます。既存の予約システム（MOSH・STORES予約等）をご利用の場合は、そちらへご案内します。' },
      ],
