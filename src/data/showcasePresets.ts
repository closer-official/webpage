...
export const SHOWCASE_BY_STYLE_ID: Record<StyleId, { content: PageContent; seo: SEOData }> = {
  ...
  navy_cyan_consult: {
    content: {
      ...
      ctaHref: '#contact',
      priceRows: [
        { name: 'スタンダード', price: '¥29,800' },
        { name: 'プレミアム', price: '¥49,800' },
      ],
      faqItems: [
        { q: '初心者でもついていけますか？', a: 'はい。基礎から段階的に進められるよう設計しています。' },
        { q: '支払い方法は？', a: 'クレジットカード・銀行振込など、お問い合わせ時にご案内します。' },
        { q: '返金ポリシーはありますか？', a: '規定に基づき対応します。詳細は個別にご説明します。' },
      ],
      sections: [
        { id: 'concept', title: 'こんな方におすすめ', content: '独学で行き詰まっている／体系立てて学び直したい／短期で成果の出る計画が欲しい、という方へ。' },
        { id: 'menu', title: '選ばれる3つの理由', content: '短時間モジュール／復習しやすい資料／質問しやすいサポートで、続けやすさを重視しています。' },
        {
          id: 'staff',
          title: 'PROFILE',
          content: '講師・設計の経歴と、このプログラムを届けたい想いをご紹介します。',
          imageUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=900',
        },
        { id: 'price', title: '料金', content: '税込表示です。お支払い方法はお問い合わせ時にご案内します。' },
        { id: 'faq', title: 'よくあるご質問', content: '' },
        { id: 'contact', title: 'まずは無料で相談', content: 'LINEまたはフォームからご連絡ください。24時間以内にご返信します。' },
      ],
