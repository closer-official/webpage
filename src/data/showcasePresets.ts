    ...
    content: {
      ...
      sections: [
        ...
        { id: 'faq', title: 'FAQ', content: 'Q. ドレスコードは？ A. スマートカジュアルでお願いします。' },
        {
          ...
          title: 'GALLERY',
          content: '店内の雰囲気。',
          imageUrl: 'https://images.unsplash.com/photo-1514933653103-974c4e9b2c3b?auto=format&fit=crop&w=800',
        },
        { id: 'contact', title: 'RESERVE', content: '完全予約制。前日までにウェブまたは電話にてご予約ください。' },
      ],
      quote: '光を消した先に、もう一つの時間が在る。',
...
export function getShowcasePreset(styleId: StyleId): { content: PageContent; seo: SEOData } {
  const p = SHOWCASE_BY_STYLE_ID[styleId];
  return {
