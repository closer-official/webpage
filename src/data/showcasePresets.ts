...
export const SHOWCASE_BY_STYLE_ID: Record<StyleId, { content: PageContent; seo: SEOData }> = {
  ...
  navy_cyan_consult: {
    content: {
      ...
      title: 'ウェブ制作 / Closer',
      headline: '運用まで見据えたサイト制作。',
      subheadline: 'コーポレートサイト・LPの設計から公開まで、事業の伝わり方を一緒に整えます。',
      ctaLabel: 'LINEで無料相談',
      ctaHref: 'https://lin.ee/nLMnCmt',
      priceRows: [
        { name: 'お見積りベース', price: '要相談' },
        { name: '保守・更新', price: 'プランに応じて' },
      ],
      faqItems: [
        { q: '納期がタイトでも大丈夫ですか？', a: 'スコープ次第で対応可能です。まずはご相談ください。' },
        { q: 'Webの知識がなくても進められますか？', a: '用語や手順はわかりやすくご説明します。' },
        { q: '公開後の更新も依頼できますか？', a: '都度お見積り、または保守プランで対応可能です。' },
      ],
      sections: [
        { id: 'concept', title: 'こんな方へ', content: 'サイトを整えたいが何から手をつけるか迷っている／問い合わせに繋がる構成にしたい、という事業者様へ。' },
        { id: 'menu', title: 'サービス', content: 'サイト設計・デザイン・実装・公開後の微修正まで、フェーズに合わせてご提案します。' },
        {
          id: 'staff',
          title: 'Closer について',
          content: 'Web制作を軸に、伝わる情報設計と運用しやすい公開までをサポートします。',
          imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900',
        },
        { id: 'price', title: '料金', content: '内容・範囲に応じてお見積りします。お支払い方法はご相談時にご案内します。' },
        { id: 'faq', title: 'よくあるご質問', content: '' },
        { id: 'contact', title: 'お問い合わせ', content: 'LINEからお気軽にご連絡ください。' },
      ],
      footerText: `© ${new Date().getFullYear()} ウェブ制作 / Closer`,
      heroSlides: ['https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1400'],
    },
    seo: {
      metaTitle: 'ウェブ制作 / Closer | サイト制作・LP・保守',
  ...
  beauty_salon_mellow: {
    ...
    seo: {
      ...
      ogImageUrl: '/beauty-salon-mellow/interior-entrance.png',
      canonicalUrl: '',
    },
  },
  beauty_salon_hpb: {
