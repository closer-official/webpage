...
export const TEMPLATES: TemplateOption[] = [
  ...
  .page-wrapper.template-cafe_1 .wo-sec-heading { font-family: "Cormorant Garamond", "Times New Roman", serif; font-size: 0.82rem; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; color: #888; margin: 0 0 1rem; }
  .page-wrapper.template-cafe_1 .wo-lede-heading { font-family: "Cormorant Garamond", "Times New Roman", serif; font-size: 0.82rem; font-weight: 600; letter-spacing: 0.22em; text-transform: uppercase; color: #888; margin: 0 0 0.75rem; }
  ...
  .page-wrapper.template-cafe_1 .c1-ig-feed-item-frame { position: relative; display: block; border-radius: 10px; overflow: hidden; border: 1px solid var(--tp-border); }
  ...
  .page-wrapper.template-cafe_1 .c1-shop-map-embed { margin: 0 0 1.25rem; border: 1px solid var(--tp-border); border-radius: 10px; overflow: hidden; background: #f6f6f6; }
  ...
  .page-wrapper.template-cafe_1 .c1-faq-item { padding: 0.85rem 0 0; border-top: 1px solid var(--tp-border); }
  ...
  @media (max-width: 768px) {
    .page-wrapper.template-cafe_1 .wo-nav-fab { left: max(1rem, env(safe-area-inset-left)); right: auto; }
